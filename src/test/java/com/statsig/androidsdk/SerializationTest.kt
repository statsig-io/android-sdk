...
class SerializationTest {
    ...
    fun testSerializeResponseWithIncomplete() {
        ...
        val gate = FeatureGate("some_gate", parsedResponse.featureGates!!.get("245595137")!!, EvaluationDetails(EvaluationReason.Error, lcut = 0))
        val config = DynamicConfig("some_config", parsedResponse.configs!!.get("2887220988")!!, EvaluationDetails(EvaluationReason.Error, lcut = 0))
